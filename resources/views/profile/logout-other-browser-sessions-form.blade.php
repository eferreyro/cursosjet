<x-jet-action-section>
    <x-slot name="title">
        {{ __('Sesiones activas de Navegador') }}
    </x-slot>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puede cerrar la sesión de todos sus navegadores y en todos sus dispositivos. A continuación se enumeran algunas de sus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si cree que su cuenta ha sido comprometida, también debería actualizar su contraseña.') }}
        </div>
