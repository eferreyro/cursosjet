        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    @can ('enrolled', $course)
                    <a class="btn btn-danger btn-block mt-4" href="{{route('courses.status', $course)}}"> Continuar Curso</a>
                    @else
                ...
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm"><i class="fas fa-star mr-2 text-yellow-400"></i>{{$similar->ratting}}</p>
                        </div>
                    </article>
                @endforeach
            </aside>
