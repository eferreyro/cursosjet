    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p class="mb-2 "><i class="fas fa-award mr-4"> </i>Matriculados: {{ $course->students_count }}</p>
                <p class="mb-2 "><i class="fas fa-star mr-2"> </i>Calificacion: {{ $course->ratting }}</p>
            </div>
        </div>
    </section>
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="order-2 lg:col-span-2 lg:order-1">
            <section class="card mb-12">
                <div class="card-body">
                    <h1 class="font-bold text-2xl mb-2">Habilidades que adquieres con este curso</h1>
            ...
            <section class="mb-8">
                <h1 class="font-bold text-3xl text-gray-800">Herramientas necesarias
                </h1>
                ...
                <div class="card-body">
                    ...
                    @else
                        @if ($course->price->value == 0)
                            <p class="text-2xl font-bold text-gray-600 mt-2 mb-2">GRATIS</p>
                            <form action="{{ route('courses.enrolled', $course) }}" method="post">
                                @csrf
                                <button class="btn btn-danger btn-block" type="submit">Tomar Curso</button>
                            </form>
                        @else
                            <p class="text-2xl font-bold text-gray-600 mt-2 mb-2">MXN {{$course->price->value}}</p>

                            <a href="{{route('payment.checkout', $course)}}" type="submit" class="btn btn-danger btn-block">Comprar curso</a>
                ...
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm"><i class="fas fa-star mr-2 text-yellow-400"></i>{{ $similar->ratting }}
                            </p>
                        </div>
                    </article>
                @endforeach
