    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
                ...
                <div class="card-body">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        @empty
                            ...
                            {{-- <i class="fas fa-exclamation-triangle fa-lg text-orange-500 mr-2"></i> --}}
                        @endforelse
            ...
            <section class="mb-12">
                ...
                @empty
                    <article class="card">
                        <div class="card-body">Este curso no tiene ninguna seccion asignada
                        </div>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside">
                    ...
                    @empty
                                                        {{-- <i class="fas fa-exclamation-triangle fa-lg text-orange-500 mr-2"></i> --}} 
                        <li class="text-gray-700 text-base"> No hay un Requerimiento para este curso</li>
                    @endforelse
                   </ul>
            </section>
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.courses.approved', $course) }}" class="mt-4" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary w-full">Publicar Curso</button>
                    </form>
